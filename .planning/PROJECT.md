...
- [ ] 클라이언트(소상공인) 정보·브랜드 톤·과거 캠페인 자산을 한 곳에서 관리
- [ ] 클라이언트 정보를 입력하면 AI가 광고 기획안(캠페인 목표·타겟·메시지·채널 믹스)을 초안으로 생성
- [ ] 채널별 광고 콘텐츠(카피·이미지 프롬프트·해시태그·CTA) 일괄 생성 — 최소 네이버 블로그/플레이스, 인스타그램, 메타·구글 광고 카피
- [ ] 직원이 초안을 검토·수정·승인하는 휴먼-인-더-루프 워크플로우
- [ ] 클라이언트별·캠페인별 콘텐츠 히스토리 보관 및 재사용
- [ ] 다인 협업: 기획자/디자이너/운영자 역할 구분과 작업 큐
- [ ] 한국어 UI·한국어 카피 품질 최우선
