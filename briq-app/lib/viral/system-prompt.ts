...
export const AI_CLICHES = [
  ...
  "정성을 들여 만든", "공들여 준비한",
  "맛집의 정수", "맛의 향연",
  // 카드뉴스/감성 시(詩)적 AI 톤 — 추상·운율 상투구
  "차곡차곡", "단단한 가게", "그 이상은 더하지", "한 줄씩 그대로",
  "한 호흡", "손길이 자기 자리", "마침표", "한 결의", "결을 느끼",
  "오롯이", "고스란히", "마음을 담은", "기다림의 미학", "한 폭의",
  "결이 살아", "시간이 멈춘", "여운이 남는",
];

// 프로 마케터 vs AI — before/after 예시 (few-shot).
// "AI가 쓴 느낌" 을 없애는 가장 강한 레버: 추상명사·운율 대신 구체 장면·숫자·실제 대사.
const PRO_VS_AI_EXAMPLES = `==== 10년차 마케터처럼 쓴다 (필독) ====
같은 메시지라도 'AI 톤'이 아니라 '실제 잘 쓰는 마케터 톤'으로. 항상 오른쪽(✓)처럼.

✗ 정성을 다해 끓인 깊은 국물      → ✓ 국물 내는 데만 아침 내내 걸려요
✗ 특별한 한 잔의 여유            → ✓ 창가 자리 앉으면 한 시간이 그냥 가요
✗ 잊지 못할 추억을 선사합니다    → ✓ 한 번 자고 가면 다음 예약부터 잡아요
✗ 고객님을 위한 최상의 서비스    → ✓ 얼굴형 보고 어울리는 톤 잡아드려요
✗ 후기를 한 줄씩 그대로 옮깁니다 → ✓ "또 올 것 같아요" — 지난주 손님 한마디
✗ 시간이 멈춘 듯한 고즈넉한 공간 → ✓ 마당에 비 오는 소리가 그대로 들려요

원칙 4가지:
1. 추상명사(정성·여유·감동·결·여운) 대신 → 구체 장면·숫자·실제 대사.
2. 형용사보다 동사. 자랑("최고의")보다 사실("아침마다 들어와요").
3. 운율·시(詩) 흉내 금지("한 결의 시간", "마침표", "한 호흡"). 말하듯이.
4. 손님이 실제로 할 법한 말, 사장님이 실제로 할 법한 말만.`;
