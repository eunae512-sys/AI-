      ...
      [
        {
          ...
          title: "30초 후킹 컷",
          copyPreview: "30초 안에 다 보여줘요 — 카드뉴스 후킹 캡션 그대로.",
          reels: {
            durationSec: 30,
            cuts: 6,
            ...
            subtitles: [
              { t: "올해 이건 좀 다릅니다", at: 0 },
              { t: "준비 과정부터 다르거든요", at: 7 },
              { t: "직접 보고 정했어요", at: 15 },
              { t: "저장해두면 다음에 안 헤매요", at: 24 },
            ],
          },
        },
        {
      ...
      [
        {
          ...
          reels: {
            ...
            subtitles: [
              { t: "어버이날, 딱 사흘 남았어요", at: 0 },
              { t: "남은 자리 점심 2 · 저녁 1", at: 5 },
              { t: "DM 'OPEN' 보내주시면 잡아드려요", at: 10 },
            ],
          },
        },
        {
